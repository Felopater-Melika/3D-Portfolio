...
const experiences = [
    ...
    },
    {
        ...
        iconBg: "#383E56",
        points: [
            "Integrated NASA's RACE-ODIN wildfire tracking system with UAV navigation algorithms.",
            "Implemented a Scala/Akka actor to aggregate dynamic data from wind and fire actors.",
            "Developed an API wrapper for the UAV navigation algorithm written in Julia.",
            "Streamed data to a Cesium.js frontend for visualization and to the UAV algorithm for optimal trajectory calculations, and rendered calculated UAV trajectories in Cesium.",
            "Created multiple graph visualizations for enhanced data analysis."
        ]
    }
];
